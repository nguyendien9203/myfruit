    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h2 class="h4 mb-1">Cập Nhật Sản Phẩm</h2>
                    <a class="btn btn-primary mb-4" href="product.jsp"><span class="fe fe-16 fe-arrow-left"></span> Quay Lại </a>
                    <div class="row">
                                    ...
                                    <div id="form-container">
                                        <div class="form-row" data-repeater-item>
                                            ...
                                            <div class="form-group col-md-7">
                                                ...
                                                <input type="text" class="form-control" id="simpleinput" placeholder="Nhập giá trị">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <button class="fe fe-16 fe-x remove-button" id="remove-form-row"></button>
                                            </div>
                                        </div>
                                    </div>

                                    <button class="btn btn-primary" id="add-form-row">Thêm Lựa Chọn Khác</button>
                                    <a class="btn ml-3 btn-outline-primary" data-toggle="modal" data-target="#varyModalAB" data-whatever="@mdo" href="#">Thêm Biến Thể</a>
                                </div> <!-- /.card-body -->
                            </div> <!-- /.card -->
                            <!-- /Variants -->
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="simpleinput">Giá Gốc</label>
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="form-label mb-1 d-flex justify-content-between align-items-center" >
                                            <span>Đơn Vị</span>
                                            <a class="btn btn-link" data-toggle="modal" data-target="#varyModalAD" data-whatever="@mdo" href="#">Thêm Đơn Vị</a>
                                        </label>
                                        <select class="form-control select2" id="simple-select2">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="form-label mb-1 d-flex justify-content-between align-items-center" >
                                            <span>Danh Mục</span>
                                            <a class="btn btn-link" data-toggle="modal" data-target=".modal-right-ac" data-whatever="@mdo" href="#">Thêm
                                                Danh Mục
                                            </a>
                                        </label>
                                        <select class="form-control select2" id="simple-select2">
...
<!-- add-parent-category -->
<div class="modal fade" id="varyModalAD" tabindex="-1" role="dialog" aria-labelledby="varyModalLabelAD" aria-hidden="true">
...
<div class="modal fade" id="varyModalAB" tabindex="-1" role="dialog" aria-labelledby="varyModalLabelAB" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
