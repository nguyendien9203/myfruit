                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="product-name" class="form-control" name="name" value="${product.name}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>SKU</label>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="brand" class="form-control" name="brand" value="${product.brand}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="qty-in-stock">Số Lượng</label>
                                            <input type="text" id="qty-in-stock" class="form-control" name="qtyInStock" value="${product.qtyInStock}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Mô tả</label>
                                            <textarea id="description" class="form-control" name="desc" rows="" cols="100">${product.desc}</textarea>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Ảnh Sản Phẩm</label>
                                            <input type="file" id="imageInput" name="image" class="form-control">
                                            <div id="image-preview" class="mt-3">
                                                <img src="${pageContext.request.contextPath}/images/uploads/${product.image}" id="preview" style="max-width: 200px; max-height: 200px;">
                                            </div>
                                        </div>
                                    </div> <!-- /.card-body -->
                                </div> <!-- /.card -->
