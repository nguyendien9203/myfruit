...
@WebServlet(name = "AdminProductAddServlet", urlPatterns = "/admin/addProduct")
public class AdminProductAddServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (categoryIds == null || categoryIds.length == 0) {
            ...
            try {
                ...
                for (String categoryId : categoryIds) {
                    ...
                    if (category == null) {
                        errors.add("Danh mục không tồn tại: " + categoryId);
                    } else {
        ...
        if(addSuccess) {
            resp.sendRedirect("product?add=true");
        }else {
            resp.sendRedirect("product?add=false");
        }
