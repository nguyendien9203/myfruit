    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Trang Chủ</a></span> <span>Đăng Kí</span></p>
        ...
        <div class="row block-9">
            <div class="col-md-6 order-md-last d-flex py-6 wrap-about pb-md-6 ftco-animate">
                <form action="#" class="bg-white p-5 contact-form">
                    ...
                    <p>Bạn Đã Có Tài Khoản Chưa? <a href="login.jsp">Đăng Nhập Ngay</a></p>
                    <div class="form-group">
